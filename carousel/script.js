...
async function slide(direction) {
    // containerArea.classList.remove(...containerArea.classList)
    console.log(containerArea.classList)
    containerArea.className = ""
    await new Promise((resolve) => setTimeout(resolve, 0))
    containerArea.classList.add('slide-' + direction);
}
